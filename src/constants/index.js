...
const schoolCertificates = [
  ...
  },
  {
    ...
    iconBg: "#1b1f3a",
    date: "Issued: See certificate",
    titleAr: "شهادة مسابقة القرآن في رمضان",
    typeAr: "إنجاز مدرسي",
    dateAr: "صادرة: عرض الشهادة",
    points: [
      "School recognition certificate.",
      "Awarded for Quran competition in Ramadan.",
    ],
    pointsAr: [
      "شهادة تقدير مدرسية.",
      "تكريم لمسابقة القرآن في رمضان.",
    ],
    credential: "/certificate-ramadan-quran-2026.html",
  },
  {
    id: "ramadanPerfectPerformance",
    title: "Perfect Performance in Ramadan",
    type: "School Achievement",
    icon: "/Logos/Qyem_logo.png",
    iconBg: "#1b1f3a",
    date: "Issued: See certificate",
    titleAr: "الأداء المثالي في شهر رمضان",
    typeAr: "إنجاز مدرسي",
    dateAr: "صادرة: عرض الشهادة",
    points: [
      "School recognition certificate.",
      "Recognizes perfect performance during Ramadan.",
    ],
    pointsAr: [
      "شهادة تقدير مدرسية.",
      "تكريم للأداء المثالي خلال شهر رمضان.",
    ],
    credential: "/certificate-ramadan-perfect-performance.html",
  },
  {
